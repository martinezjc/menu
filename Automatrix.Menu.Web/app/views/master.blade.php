  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <div style="float:left;height:100%;width: 350px;">
        @if ($src == 'uploads/dealer/')        
        <a class="navbar-brand-noImage" alt="{{ $alt }}" href="home"> Your logo here!</a>
        @else
        <a class="navbar-brand" alt="{{ $alt }}" href="home"></a>
        @endif
      </div>
    </div>
    ...
    <p>Logged as <a href="profile?UserId={{$UserSessionInfo->UserId}}">{{ $UserSessionInfo->FirstName }}</a> <a href="close-session"><i class="fa fa-sign-out"></i> Logout</a></p>
    </div>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
