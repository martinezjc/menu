...
<div class="row">
    <div class="col-md-9">
      ...
      <a class="btn btn-success" id="generalSettings" href="{{ $baseUrl }}/dealers/{{ $currentUser->DealerId }}/products"><i class="fa fa-times"></i> Cancel</a>
...
<div class="modal fade" id="RangePricingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body row">
        ...
        <tbody>
          <tr>
              <td><input type="text" name="TermFrom" class="form-control ignore pull-left"></td>
              <td><input type="text" name="TermTo" class="form-control ignore pull-left"></td>
              <td><input type="text" name="CostPurchase" class="form-control" style="text-align:right;"></td>
              <td><input type="text" name="CostLease" class="form-control" style="text-align:right;"></td>
              <td><input type="text" name="CostBalloon" class="form-control" style="text-align:right;"></td>
              <td><input type="text" name="SellingPrice" class="form-control" style="text-align:right;"></td>
          </tr>
          <tr>
              <td><input type="text" name="TermFrom" class="form-control ignore pull-left"></td>
              <td><input type="text" name="TermTo" class="form-control ignore pull-left"></td>
...
<input type="hidden" id="DealerId" value="{{ $currentUser->DealerId }}">
</div>
</div>
</div> <!-- end row class -->
