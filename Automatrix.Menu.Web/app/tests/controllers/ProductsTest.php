...
class ProductsTest extends TestCase {
	...
	{
		$this->mock = m::mock('Eloquent', 'Product');
	...
	public function setUp()
	{
		...
		$this->attributes = Factory::Product(['id' => 1]);
	...
	public function testStoreFails()
	{
		...
		$this->assertRedirectedToRoute('Products.create');
	...
	public function testUpdate()
	{
		...
		$this->validate(true);
		$this->call('PATCH', 'Products/1');

		$this->assertRedirectedTo('Products/1');
	}
	...
	public function testUpdateFails()
	{
		...
		$this->assertRedirectedTo('Products/1/edit');
		$this->assertSessionHasErrors();
		$this->assertSessionHas('message');
	}
